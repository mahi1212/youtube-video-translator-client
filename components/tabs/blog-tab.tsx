...
export function BlogTab() {
  ...
  const simulateBlogGeneration = async () => {
    ...
    setBlogContent(`
      ...
      ${includeImages ? '<img src="/placeholder.svg?height=400&width=600" alt="Train journey to London" class="w-full rounded-lg my-6" />' : ''}
      ...
      ${includeImages && imageCount > 1 ? '<img src="/placeholder.svg?height=300&width=500" alt="People talking on train" class="w-full rounded-lg my-6" />' : ''}
      ...
      ${includeImages && imageCount > 2 ? '<img src="/placeholder.svg?height=350&width=550" alt="Language learning success" class="w-full rounded-lg my-6" />' : ''}
      ...
      <Card className="bg-white/80 backdrop-blur border-0 shadow-lg">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="blog-prompt">Blog Instructions (Optional)</Label>
            <Textarea
              id="blog-prompt"
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="include-images">Include generated images</Label>
            </div>
